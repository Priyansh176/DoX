      ...
      Card(
        ...
        child: Padding(
          ...
          child: Center(
            child: Column(
              children: [
                const Text('YOUR TOKEN', style: TextStyle(color: Colors.white70, letterSpacing: 1.2)),
                Text('#${booking.tokenNumber}', style: GoogleFonts.outfit(color: Colors.white, fontSize: 62, fontWeight: FontWeight.w700)),
                const SizedBox(height: 8),
                Text(queue.status, style: const TextStyle(color: Color(0xFFFFD84D), fontWeight: FontWeight.bold)),
              ],
            ),
          ),
        ),
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(value, style: GoogleFonts.outfit(fontSize: 25, fontWeight: FontWeight.w700)),
        ],
      ),
    ),
  );
